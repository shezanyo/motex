...
@section("content")
                ...
                <div class="carousel-inner container mx-auto">
                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 col-md-12 wow slideInRight" >
                                <img src="{{ asset('assets/images/slidesCar/car1.png') }}" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                    <!-- 2nd slide -->
                    <div class="carousel-item ">
                        <div class="row">
                            ...
                            <!-- 2nd column -->
                            <div class="col-12 col-lg-6 col-md-12 wow slideInRight" >
                                <img src="{{ asset('assets/images/slidesCar/car2.png') }}" class="d-block w-100" alt="Slide 2">
                            </div>
                        </div>
                    </div>
                    <!-- 3rd slide -->
                    <div class="carousel-item ">
                        <div class="row">
                            ...
                            <!-- 2nd column -->
                            <div class="col-12 col-lg-6 col-md-12 wow slideInRight" >
                                <img src="{{ asset('assets/images/slidesCar/car3.png') }}" class="d-block w-100" alt="Slide 3">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-md-12 position-relative wow slideInLeft" >
                    <img src="{{ asset('assets/images/poster.png') }}" class="d-block w-100" alt="poster car">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/latest/l1.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/latest/l2.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/latest/l3.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/latest/l4.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <section class="container mx-auto" style="margin-top: 70px;">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-4">
            ...
            <div class="col wow fadeIn" >
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car1.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn" >
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car2.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car3.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car4.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car5.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car6.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car7.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car8.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car9.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car10.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car11.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/carTypes/car12.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
    ...
    <section class="container mx-auto "  style="margin-top: 70px;">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/dealers/d1.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/dealers/d2.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/dealers/d3.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow fadeIn">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/dealers/d4.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
    ...
    <section class="poster-background" style="margin-top: 70px; padding: 40px;">
        ...
        <div class="container mx-auto ">
            <div class="row">
                ...
                <!-- 2nd column -->
                <div class="col-12 col-lg-6 col-md-12 wow slideInRight" >
                    <img src="{{ asset('assets/images/poster2.png') }}" class="d-block w-100" alt="Slide 1">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container mx-auto" style="margin-top: 70px;">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-4">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b1.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b2.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b3.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b4.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b5.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
            ...
            <div class="col wow bounce">
                <div class="card h-100 cardStyle">
                    <img src="{{ asset('assets/images/brands/b6.png') }}" class="card-img-top px-4" alt="...">
                    <div class="card-body">
